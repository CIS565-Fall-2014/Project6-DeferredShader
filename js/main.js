...
var zFar = 2000;
var texToDisplay = 1;
var lgtClr=[0.8,0.5,0.2];
var lgtPos=[0.0,0.0,10.0];
var sampler = [];
var kernelSize = 80;
var radius=0.05;
...
var renderShade = function () {
  ...
  gl.uniform3fv(shadeProg.uLgtPosLoc,lgtPos);
  gl.uniform3fv(shadeProg.uLgtClrLoc,lgtClr);
  drawQuad(shadeProg);
...
var initKernel = function () {
    for (var i = 0; i < kernelSize; i++) {
        ...
        sampler[i] = [Math.random() * x, Math.random() * y, Math.random() * z];
    }
};
...
var renderPost = function () {
	...
	gl.uniform1f(postProg.uRadLoc,radius);
	
	gl.uniform3fv(postProg.uSamplerLocation, sampler);
...
var initObjs = function () {
  ...
  //objloader.loadFromFile(gl, "assets/models/crytek-sponza/sponza.obj", "assets/models/crytek-sponza/sponza.mtl");
	...
	//objloader.loadFromFile(gl, "assets/models/teapot.obj", null);
...
var initShaders = function () {
  ...
  shadeProg.addCallback( function() { 
	...
	shadeProg.uLgtPosLoc=gl.getUniformLocation(shadeProg.ref(), "lgtPos");
	shadeProg.uLgtClrLoc=gl.getUniformLocation(shadeProg.ref(), "lgtClr");
  });
  ...
  postProg.addCallback( function() { 
	...
	postProg.uRadLoc=gl.getUniformLocation(postProg.ref(),"u_rad");
	postProg.uSamplerLocation=gl.getUniformLocation(postProg.ref(),"u_sampler");
  });
